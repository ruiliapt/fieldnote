...
Fieldnote Lite 使用**单实例运行机制**，防止同时启动多个程序实例。
...
| 程序 | 锁文件 | 是否冲突 |
|------|--------|----------|
| Fieldnote Lite | `/tmp/fieldnote_lite.lock` | ❌ |
