...
Fieldnote Lite 是一个面向语言学研究者的田野笔记管理工具，特别适用于田野调查数据、方言语料、少数民族语言记录等需要维护带音标和语法注释的语料。
...
### Q: 可以同时打开多个程序窗口吗？
A: 不可以。Fieldnote 使用单实例运行机制，防止数据库冲突。如果尝试再次启动，会提示"程序已在运行"。
